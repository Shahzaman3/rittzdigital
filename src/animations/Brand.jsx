...
export default function Brand() {
  ...
  return (
    <div className="bg-gray-200 px-2 z-0 overflow-x-hidden">
      {/* Mobile/Small layout without animation */}
      <div className="block md:hidden py-10">
  {/* For better width handling from 375px to 639px */}
  <div className="mx-auto w-full max-w-[90%] space-y-8">
    ...
    <div className="bg-amber-500 text-white rounded-[30px] px-4 sm:px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-4">
      ...
      <div className="w-full sm:w-[65%] sm:pl-4">
        <p className="sm:text-lg font-semibold text-gray-800">Behind The Brand</p>
      ...
      <div className="relative bg-white w-36 h-36 sm:w-40 sm:h-40 rounded-md flex-shrink-0">
        ...
        />
        <img src="/assets/Rectangle 4207.png" className="absolute bottom-8 right-10" />
        <img src="/assets/Ellipse 60.png" className="absolute bottom-10 right-6" />
        <img src="/assets/Polygon 1.png" className="absolute top-8 left-6" />
      </div>
    </div>
    ...
    <div className="bg-[#fff6db] text-black rounded-[30px] px-4 sm:px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-4">
      ...
      <div className="w-full sm:w-[65%] sm:pl-4">
        ...
        <p className="sm:text-xl font-semibold">
          ...
          <span className="text-yellow-500">products</span> that put <br /> customers first.
        </p>
      </div>
      ...
      <div className="border border-yellow-500 relative w-[190px] h-[190px] rounded-md overflow-hidden flex-shrink-0">
        <div className="relative w-full h-full p-4">
          ...
          />
          <img src="/assets/Rectangle 4207.png" className="absolute bottom-8 right-10" />
          <img src="/assets/Ellipse 60.png" className="absolute bottom-6 right-14" />
          <img src="/assets/Polygon 1.png" className="absolute top-6 left-14" />
        </div>
      </div>
    </div>
      ...
      {/* 3D Cube layout for md and above */}
      <div
